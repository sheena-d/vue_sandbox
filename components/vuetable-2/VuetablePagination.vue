<template>
    <ul v-show="tablePagination && tablePagination.last_page > 1" :class="css.wrapperClass">
        <li :class="[css.pageClass, isOnFirstPage ? css.disabledClass : '']" ><a @click="loadPage(1)"
           :class="['btn-nav', css.linkClass]">
            <i v-if="css.icons.first != ''" :class="[css.icons.first]"></i>
            <span v-else>&laquo</span>
        </a></li>
        <li :class="[css.pageClass, isOnFirstPage ? css.disabledClass : '']" ><a @click="loadPage('prev')"
           :class="['btn-nav', css.linkClass]">
        ...
        <li :class="[css.pageClass, isOnLastPage ? css.disabledClass : '']" ><a @click="loadPage(totalPage)"
           :class="['btn-nav', css.linkClass]">
